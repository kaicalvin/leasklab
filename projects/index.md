...
{% capture col1 %}
{% include button.html type="github" icon="fa-solid fa-flask-vial" text="Equitable Genomics" link="#equitable-genomics---advancing-research-health-and-capability" tooltip="Equitable Genomics" %}
